    ...
    async with websockets.connect(browser_ws) as ws:
        ...
        (() => {
            ...
            return {
                ...
                activeModelUri: activeModel ? activeModel.uri.toString() : null,
                activeModelVal: activeModel ? activeModel.getValue().slice(0, 150) : null
            };
        })()
        """
        ...
        while True:
            r = json.loads(await ws.recv())
            if r.get("id") == 2:
                print("Active editor:", json.dumps(r["result"]["result"]["value"], indent=2))
                break
